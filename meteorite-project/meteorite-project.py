...
# get_countries convert list of coordinates to counter of country codes.
...
# is_published will check whether the country publised an article in a particular year
...
# gets data from the nasa website and store in local disck for further processing. had saved file in local for testing purpose only.
def get_data():
    ...
    if os.path.isfile('./input/input.json'):
        ...
        try:
            ...
            print("Error during getting data from NASA website...")
...
def main():
    ...
    if not df_2008.empty and not df_2010.empty:
